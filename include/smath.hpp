...
constexpr Vector3 forward  (0.0,  0.0,  1.0);
constexpr Vector3 backward (0.0,  0.0, -1.0);
constexpr Vector3 one      (1.0,  1.0,  1.0);
...
constexpr Vector2 up2   (0.0, -1.0);
constexpr Vector2 down2 (0.0,  1.0);
constexpr Vector2 left2 (-1.0, 0.0);
constexpr Vector2 right2(1.0,  0.0);
constexpr Vector2 one2  (1.0,  1.0);
constexpr Vector2 zero2 (0.0,  0.0);
